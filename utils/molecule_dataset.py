...
#     def __init__(self, root, graphs=None, labels=None, transform=None, pre_transform=None, pre_filter=None):
#         self.graphs = graphs
#         self.labels = labels
#         self.length = 4110
...
#     @property
#     def processed_file_names(self):
#         return [f'nci_data_{idx}.pt' for idx in range(self.length)]

#     def process(self):
#         for idx, (data,label) in enumerate(zip(self.graphs, self.labels)):
...
#             torch.save(data, os.path.join(self.processed_dir, f'nci_data_{idx}.pt'))
            
#     def len(self):
#         return len(self.processed_file_names)

#     def get(self, idx):
#         data = torch.load(os.path.join(self.processed_dir, f'nci_data_{idx}.pt'))
#         return data
