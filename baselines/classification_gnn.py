...
def main():
    ...
    # dataset StratifiedKFold
    # labels for Graph Classification and Node Classification
    # labels = dataset.data.y.argmax(dim=1).tolist()
    labels = dset.data.y.tolist()
    split_dataset(labels,args.dataset,n_splits=10,seed=args.seed)
