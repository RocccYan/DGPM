...
class ModelArguments:
    ...
    model_name_node: str = field(default="")
    model_name_motif: str = field(default="")
    model_file_name: str = field(default="")
    model_file_name_motif: str = field(default="")
    model_file_name_node: str = field(default="")
...
@dataclass
class ClassficationArguments:
    task_name: str = field(default='task',
                           metadata={"help": "Task name."})
    fold_idx_path: str = field(default="../supervised_data/fold-idx",
                               metadata={"help": "./supervised_data/fold-idx"})
    eval_mode: str = field(default='motif')
    pooler: str = field(default='sum')
    encode_type: str = field(default='cat')
    seed: int = field(default=42,
                      metadata={"help": "set random state."})
    # seeds: list = field(default=[0,1,2,3,4])
    device: str = field(default='gpu',
                      metadata={"help": "set random state."})
    num_epochs: int = field(default=200,
                            metadata={"help": "Maximum Number of Epochs to Train the Model."})
    ...
    drop_pretrain: int = field(default=0,
                                metadata={"help": "whether drop pretrained parameters."})
    load_cross_trained: int = field(default=0)
...
class TrainingArguments:
    ...
    print_per_epoch: int = field(default=20,
                                metadata={"help": "Save the model per #epoches."})
    use_early_stopping: int = field(default=0,)
    scheduler: int = field(default=0,)
    load_cross_trained: int = field(default=0)
    eval_train: int = field(default=0)
    eval_mode: str = field(default='motif')
    pooler: str = field(default='sum')
    encode_type: str = field(default='cat')
