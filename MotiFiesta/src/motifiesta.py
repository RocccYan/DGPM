...
from MotiFiesta.src.train import motif_train
...
parser.add_argument("--stop-epochs", "-se", type=int, default=50, help="Number of epochs to train embeddings before doing motifs.")
...
# roc
parser.add_argument("--chem", "-c", default=False, action='store_true', help="whether need transfer node features by Embedding layer.")
...
print(num_features)
dump_model_hparams(run_name, hparams)
